  ...
  return (
    <div id="top" className="min-h-screen bg-black text-zinc-100">
      <main className="pt-[calc(4rem+env(safe-area-inset-top,0px))]">
        <section className="relative overflow-x-clip overflow-y-visible pb-14 sm:pb-16 lg:pb-20">
          <ScrollParallaxLayer
          ...
          <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-8 px-3 pb-4 pt-12 min-[430px]:px-5 sm:gap-10 sm:px-6 sm:pb-5 sm:pt-14 lg:pb-5 lg:pt-20">
            <Reveal className="relative" instant>
              ...
              <div className="mx-auto flex w-full max-w-[min(100%,56rem)] flex-col items-center gap-7 text-center max-[360px]:px-0.5 max-sm:gap-9 sm:gap-8 lg:grid lg:max-w-5xl lg:grid-cols-[minmax(0,24rem)_minmax(0,1fr)] lg:items-start lg:gap-x-14 lg:gap-y-6 lg:text-left xl:gap-x-16">
